...
//	}
	...
	public static long handleKeyDown(long state, int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_SHIFT_RIGHT) {// 如果当前的键盘事件是左shift被按下
		...
		if (keyCode == KeyEvent.KEYCODE_ALT_LEFT || keyCode == KeyEvent.KEYCODE_ALT_RIGHT || keyCode == KeyEvent.KEYCODE_NUM) {// 如果当前的键盘事件是左alt被按下
		...
		if (keyCode == KeyEvent.KEYCODE_SYM) {// 如果当前的键盘事件是左sym被按下
		...
		if (keyCode == KeyEvent.KEYCODE_SHIFT_LEFT) {// 如果当前的键盘事件是右shift被按下
