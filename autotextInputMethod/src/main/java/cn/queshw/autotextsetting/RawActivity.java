...
public class RawActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rawListview = findViewById(R.id.raws_listview_layout_rawactivity);
		...
		// 给输入框设置按键监听器
		searchEditText = findViewById(R.id.search_edittext_layout_rawactivity);
		...
		// 获得导入导出状态显示的TextView
		statusTextView = findViewById(R.id.status_textview_layout_rawactivity);
	}
