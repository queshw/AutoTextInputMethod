...
public class GenAutotext {
	...
	private final ArrayList<String> input = new ArrayList<String>();// 用于存放autotext条目的input
	private final ArrayList<String> autotext = new ArrayList<String>();// 用于存放autotext条目的autotext
    private final int numcodesPrepage = 6;//每页最多几个编码，最大为9，最小为2
	...
	public void gen(String line) {
		...
		if (candiPageNumber > 1) {// 如果超过一页，则在开头后结尾加上中文的中括号
			pages[1] = CHINESE_QUOTATION_LEFT + pages[1];
