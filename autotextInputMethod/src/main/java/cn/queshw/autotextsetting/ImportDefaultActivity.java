...
public class ImportDefaultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		filenameTextview = findViewById(R.id.filename_textview_layout_importdefault);
		importProgressBar = findViewById(R.id.import_progressbar_layout_importdefault);
		statusTextview = findViewById(R.id.status_textview_layout_importdefault);
		...
		handler = new Handler() {			
			public void handleMessage(Message msg) {
				...
				if (msg.what != -1) {
					...
					statusTextview.setText(msg.arg2 + "/" + lines);
				}
			}
		};
