...
public class FilePickerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 获取布局中的元素
		fileListView = findViewById(R.id.file_listView_layout_filepickeractivity);
		resultEditText = findViewById(R.id.result_editText_layout_filepickeractivity);
		yesButton = findViewById(R.id.yes_button_layout_filepickeractivity);
		noButton = findViewById(R.id.no_button_layout_filepickeractivity);
		parentButton = findViewById(R.id.parent_button_layout_filepickeractivity);
		pathSpinner = findViewById(R.id.path_spinner_layout_filepickeractivity);
